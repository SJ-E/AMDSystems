...
ALTER TABLE [dbo].[ip_invoices] DROP CONSTRAINT [FK__ip_invoic__user___2E70E1FD]
GO

ALTER TABLE [dbo].[ip_invoices] DROP CONSTRAINT [FK__ip_invoic__invoi__30592A6F]
GO
...
/****** Object:  Table [dbo].[ip_invoices]    Script Date: 5/26/2018 2:13:43 AM ******/
